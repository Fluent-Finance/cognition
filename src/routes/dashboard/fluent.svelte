...
<Heading class="font-['Kalam'] text-slate-800/[0.4] dark:text-slate-200/[0.4] justify-between w-full font-medium prose-h1 text-center p-9 mb-10" tag="h1" customSize="text-xl lg:text-xl 2xl:text-4xl">{title}</Heading>
