...
<section class="bg-white dark:bg-transparent">
  <div id="anchor-learnmore" class="py-8 px-4 min-h-screen mx-auto max-w-screen-xl text-center sm:py-16 lg:px-6">
    <h1 class={h1classes}>
      Interoperable Infrastructure for a Fragmented Financial System
    </h1> 
    <p class={pclasses}>
    ...
    <h2 class="font-neuehass my-10 text-3xl font-extrabold leading-none tracking-tighter opacity-90 text-base-200 dark:text-base-300 xl:text-5xl">
